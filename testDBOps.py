from databaseOperations import search_display_name, get_team_player_tables, get_all_teams, get_player_data
import pprint
...
matching_player = get_player_data(league, matching_rows[1]["teamName"], matching_rows[1]["playerId"], db_params)
# Print the results
